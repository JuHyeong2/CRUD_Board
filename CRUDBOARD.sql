...
COMMENT ON COLUMN USER_TB.USER_ADDRESS IS '회원 주소';

INSERT INTO USER_TB VALUES(SEQ_USERNO.NEXTVAL, '장지용', 'qhem1', 'qwer1', '010-2323-4434', 'jiyong@gmail.com', '2017-10-02', '서울시 마포구');
INSERT INTO USER_TB VALUES(SEQ_USERNO.NEXTVAL, '다니엘', 'qhem2', 'qwer2', '010-5834-6231', 'niel@gmail.com', '2017-11-22', '서울시 강남구');
INSERT INTO USER_TB VALUES(SEQ_USERNO.NEXTVAL, '안지훈', 'qhem3', 'qwer3', '010-2142-3245', 'jihoon@gmail.com', '2018-08-30', '서울시 중구');
INSERT INTO USER_TB VALUES(SEQ_USERNO.NEXTVAL, '한정현', 'qhem4', 'qwer4', '010-2314-2353', 'junghyun@gmail.com', '2019-04-06', '서울시 노원구');
INSERT INTO USER_TB VALUES(SEQ_USERNO.NEXTVAL, '김도현', 'qhem5', 'qwer5', '010-2453-4564', 'dohyun@gmail.com', '2020-05-10', '서울시 영등포구');
...
CREATE TABLE BOARD_TB (
    ...
    BOARD_VIEW INT,
    CONSTRAINT FK_BD FOREIGN KEY (USER_NO) REFERENCES USER_TB(USER_NO) ON DELETE CASCADE
);
...
COMMENT ON COLUMN BOARD_TB.USER_ID IS '게시한 회원 번호';
COMMENT ON COLUMN BOARD_TB.BOARD_VIEW IS '게시글 조회수';

INSERT INTO BOARD_TB VALUES(SEQ_BOARDNO.NEXTVAL, '테스트', '테스트입니다', DEFAULT, 1, 1);
...
CREATE TABLE COMMENT_TB (
   ...
   CONSTRAINT FK_CB_USER FOREIGN KEY (USER_NO) REFERENCES USER_TB(USER_NO) ON DELETE CASCADE,
...
COMMENT ON COLUMN COMMENT_TB.USER_ID IS '댓글 작성한 회원 번호';
...
INSERT INTO COMMENT_TB VALUES(SEQ_COMMENTNO.NEXTVAL, 2, 1, '댓글 내용입니다.', DEFAULT);
